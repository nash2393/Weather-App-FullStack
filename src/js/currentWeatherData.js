...
export const currentWeatherData = async (data, key) => {
  ...
  if (data.lat && data.lon) {
    API_URL = `https://api.openweathermap.org/data/2.5/weather?lat=${data.lat}&lon=${data.lon}&appid=3143362703b364845f74b6b610e3b88a&units=metric`;
  } else {
    API_URL = `https://api.openweathermap.org/data/2.5/weather?q=${data}&appid=3143362703b364845f74b6b610e3b88a&units=metric`;
  }
